      ...
      <div class="deail-section">
        ...
        <div class="ai-analysis-result">
          <el-descriptions :column="2" border>
            <el-descriptions-item label="主要情绪">
              <el-tag
                :type="getAiEmotionTagType(aiData?.primarytEmotion || '-')"
              >
                {{ aiData?.primarytEmotion || "-" }}
              </el-tag>
            </el-descriptions-item>
          ...
          <div class="ai-improvements-section">
            ...
            <ul class="improvements-list">
              <li v-for="item in aiData?.improvementSuggestion" :key="item">
                {{ item || "-" }}
              </li>
            </ul>
          </div>
...
import { getEmotionalPage, deleteEmotion } from "@/api/admin";
