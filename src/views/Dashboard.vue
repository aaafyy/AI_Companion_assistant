    ...
    <el-row style="margin-top: 20px" :gutter="20">
      <el-col :span="12">
        <el-card style="width: 100%">
          <template #header>
            <div class="header-content">情绪趋势分析</div>
          </template>
      ...
      <el-col :span="12">
        <el-card style="width: 100%">
          <template #header>
            <div class="header-content">咨询会话统计</div>
          </template>
          <div class="chart-content">
            <div
              v-if="aiData.consultationStats && aiData.systemOverview"
...
const initEmotionChart = () => {
  ...
  // 初始化新的图表,创建echarts实例
  emtionChart = echarts.init(emotionChartRef.value);
  // 获取情绪趋势的数据
